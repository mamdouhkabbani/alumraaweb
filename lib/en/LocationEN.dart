...
class LocationEN extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<Location> {
  final controller = MapController(
    location: LatLng(33.427231, 36.2091992),
  );

  bool _darkMode = false;

  final markers = [
    LatLng(33.427231, 36.2091992),
    /*LatLng(35.676, 51.41),
    LatLng(35.678, 51.41),
    LatLng(35.68, 51.41),
    LatLng(35.682, 51.41),
      ...
      body: MapLayoutBuilder(
        ...
        builder: (context, transformer) {
          ...
          final markerWidgets = markerPositions.map(
                (pos) => _buildMarkerWidget(pos, Colors.red,"sahnaya shop"),
          );
          ...
          _buildMarkerWidget(LABLocation, Colors.red,"Factory");

          final Shopocation =
          transformer.fromLatLngToXYCoords(LatLng(33.4996856,36.2792066));

          final ShopocationMarkerWidget =
          _buildMarkerWidget(Shopocation, Colors.red,"Kfarsouseh shop");
