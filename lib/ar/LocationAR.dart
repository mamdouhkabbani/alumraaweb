...
class LocatonAR extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<Locaton> {
  final controller = MapController(
    location: LatLng(33.431221,36.227810),
  );

  bool _darkMode = false;

  final markers = [
    LatLng(33.431221,36.227810),
    /*LatLng(35.676, 51.41),
    LatLng(35.678, 51.41),
    LatLng(35.68, 51.41),
    LatLng(35.682, 51.41),
  ...
  double s=50;
  Widget _buildMarkerWidget(Offset pos, Color color,String S) {
    return Positioned(
      left: pos.dx - 16,
      top: pos.dy - 16,
      width: 20,
      ...
      child: GestureDetector(
        child:
        Icon(Icons.location_on, color: color,size: s,),
      ...
      body: MapLayoutBuilder(
        ...
        builder: (context, transformer) {
          ...
          final markerWidgets = markerPositions.map(
                (pos) => _buildMarkerWidget(pos, Colors.red,"محل صحنايا"),
          );

          final LABLocation =
          transformer.fromLatLngToXYCoords(LatLng(33.419651,36.253830));

          final homeMarkerWidget =
          _buildMarkerWidget(LABLocation, Colors.red,"مصنع");

          final Shopocation =
          transformer.fromLatLngToXYCoords(LatLng(33.497368,36.280472));

          final ShopocationMarkerWidget =
          _buildMarkerWidget(Shopocation, Colors.red,"محل كفرسوسة");
